...
public class EmployeeController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("EmpId,Name,HireDate,DeskAssignment")] Employee employee)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? empid, [Bind("EmpId,Name,HireDate,DeskAssignment")] Employee employee)
    {
